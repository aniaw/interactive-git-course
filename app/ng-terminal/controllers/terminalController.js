...
{
    'use strict';
    function terminalController($scope, terminalConfiguration, promptCreator)
    {
    ...
    module.controller('terminalController', ['$scope', 'terminalConfiguration', 'promptCreator', terminalController]);
})();